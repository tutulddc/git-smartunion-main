        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('backend') }}/images/logo4.png" alt="">
                <img class="logo-compact" src="{{ asset('backend') }}/images/logo6.png" alt="">
                <img class="brand-title" src="{{ asset('backend') }}/images/logo6.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    {{-- <img alt="image" width="50" src="{{asset('uploads/user')}}/{{ Auth::user()->picture }}"> --}}
                                    {{-- @if ($user->photo == null)
                                    ...
                                    <img src="{{ Avatar::create(Auth::user()->department)->toBase64() }}" />
                                    @else
                                    <img src="{{asset('uploads/user')}}/{{ Auth::user()->logo }}" width="20" alt="" />
                                    @endif
